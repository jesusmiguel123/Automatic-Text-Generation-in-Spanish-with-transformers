...
\begin{itemize}
    ...
    \item Se demostró que los métodos de sampling son mejores que los métodos de búsqueda en el momento de generación de texto. En el sentido de que genera texto más realista y con menos repeticiones.
\end{itemize}
